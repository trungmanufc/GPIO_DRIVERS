...
void USART_DeInit(USART_Periph *pUSARTx);
 ...
 */
void USART_PeripheralControl(USART_Periph *pUSARTx, uint8_t EnOrDi);
uint8_t USART_GetFlagStatus(USART_Periph *pUSARTx , uint32_t FlagName);
void USART_ClearFlag(USART_Periph *pUSARTx, uint16_t StatusFlagName);
