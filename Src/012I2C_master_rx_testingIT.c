...
void I2C1_GPIOInits(void)
{
	...
	//sda
	I2CPins.GPIO_PinConfig.GPIO_Pin = GPIO_PIN_NO_7;
	GPIO_Init(&I2CPins);
...
void I2C_ApplicationEventCallback(I2C_Handle_t *pI2CHandle,uint8_t AppEv)
{
	...
	else if(AppEv == I2C_ERROR_AF)
	{
		...
		//in master ack failure happens when salve fails to send ack for the byte
		//sent from the master
		I2C_CloseSendData(pI2CHandle);

		//generate stop condtition to release the bus
